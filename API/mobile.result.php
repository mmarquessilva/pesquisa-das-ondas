...
?>
<div class="col-10 gradient p-0 wow fadeInRight" data-wow-delay="0s" data-wow-duration=".3s">
  <div class="result-container">
    ...
    <div class="row result-header pt-5 panel-result">
        <div class="col-sm-12 col-md-4">
            ...
            <h5 class="ruim">0 a 5 RUIM</h5>
            <h5 class="medio">6 A 10 MÉDIO</h5>
            <h5 class="bom">11 A 15 BOM</h5>
        </div>
        <?php
    ...
    <div class="row result-content">
      <div class="col-12 p-0">
        <h2 class="title">PERFORMANCE NAS ONDAS</h2>
        <?php
          $pieces = explode(" * ", $wave);
          if(isset($pieces['0'])){
            echo "<h3 class=\"highlight\">".$pieces['0']."</h3>";
    ...
    <div class="row result-footer">
      <div class="col-12 col-md-7 pl-0">
        ...
        <p>Entre em contato conosco para trabalharmos as <strong>3 Ondas de Branding</strong> da sua Empresa.</p>
      </div>

      <div class="col-12 col-md-5 pr-0 flex-end">
        <a class="button button--black" href="http://www.anacouto.com.br/contato/" target="_blank">Entre em contato
...
<!-- RESTART BUTTON -->
<div class="col-12 button button--large background--black">
